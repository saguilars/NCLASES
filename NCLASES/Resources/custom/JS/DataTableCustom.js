    ...
    var EditableTable = {
      ...
      events: function events() {
        ...
        this.$table.on('click', 'a.save-row', function (e) {
          ...
          bootbox.dialog({
            message: "Estás Seguro que deseas eliminar la linea seleccionada?",
      ...
      rowAdd: function rowAdd() {
        ...
        actions = ['<a href="#" class="btn btn-sm btn-icon btn-pure btn-default on-editing save-row" data-toggle="tooltip" data-original-title="Guardar" hidden><i class="icon fa-check-square-o" aria-hidden="true" style="font-size: 28px; color: #46BE8A;"></i></a> <a href="#" class="btn btn-sm btn-icon btn-pure btn-default on-editing cancel-row" data-toggle="tooltip" data-original-title="Cancelar" hidden><i class="icon fa-remove" aria-hidden="true" style="font-size: 28px; color: #F96868;"></i></a> <a href="#" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row" data-toggle="tooltip" data-original-title="Editar"><i class="icon fa-edit" aria-hidden="true" style="font-size: 28px; color: #62A8EA;"></i></a> <a href="#" class="btn btn-sm btn-icon btn-pure btn-default on-default remove-row" data-toggle="tooltip" data-original-title="Eliminar"><i class="icon fa-trash-o" aria-hidden="true" style="font-size: 28px; color: #F96868;"></i></a>'].join(' ');
